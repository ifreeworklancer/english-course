    ...
    <div class="container">
        ...
        <div class="row mt-3 mt-sm-5 mb-4">
            <div class="col-sm-12 col-lg-10">
                <ul class="footer-menu-list list-unstyled d-flex flex-column flex-sm-row justify-content-between align-items-center">
                    <li class="footer-menu-list-item">
                        <a href="#" class="footer-menu-list-item__link">ОТЗЫВЫ</a>
                    </li>
                    <li class="footer-menu-list-item">
                    ...
                    <li class="footer-menu-list-item">
                        <a href="#" class="footer-menu-list-item__link">СТАТЬИ</a>
                    </li>
                    <li class="footer-menu-list-item">
        ...
        <div class="row">
            ...
            <div class="footer-copyr text-center py-4">
                <div class="footer-copyr__text">2018 Все права защищены.</div>
                <div class="footer-copyr__text footer-copyr__text--big">Дизайн и разработка <span class="text-bold">Impression Bureau</span></div>
            </div>
        </div>
        </div>
    </div>
